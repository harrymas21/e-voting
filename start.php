...
<body>
	...
	<!-- BEGIN BODY CONTENTS -->
        <div class="content-wrapper">
         ...
         <h4> ID:</h4><input type="password" name="id" class="form-control" placeholder="Id" required><br/>
                         <button class="btn btn-lg btn-primary btn-block" type="submit"><h3>LOG IN </h3>
                         </button>
                         </form><br>
                             <script type="text/javascript">
</script>
                             <a href="resetPassword.php"><img src="img/reset.png" id="reset" alt="reset password" height="50" width="150"/></a>                              
                                <br/><br/>
