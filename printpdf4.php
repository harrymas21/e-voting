...
function Footer()
{
   ...
   $this->SetFont('Helvetica','',25);
   $this->SetFontSize(10);
    $this->Cell(0,10,'----------ONLINE VOTING SYSTEM---------',0,0,'C');
}
...
$strSQL = "SELECT * FROM student_posts WHERE post_id = 5 ORDER BY votes DESC";
...
$pdf->AddPage();
	...
	$pdf->Cell(68);
	$pdf->Write(5, 'School Representative Votes Report');
	$pdf->Ln();
